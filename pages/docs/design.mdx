...
So... IDE will show `ProductApi` in autocompletion, and if you select it, it will import `fnapi/product.js`.
If you are experienced js developer, you may get it.

Also, you can do `ProductApi.searchProducts(query)`, instead of sending an untyped http request, with perfect autocompletion of the IDE.
